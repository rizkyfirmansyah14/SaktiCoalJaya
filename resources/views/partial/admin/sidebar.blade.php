<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="{{url('/dashboard')}}"><img
                src="{{ asset('assets/admin/assets/images/logo.svg')}}" alt="logo" /></a>
    ...
    <ul class="nav">
            ...
            <div class="profile-desc">
                <div class="profile-pic">
                    <div class="count-indicator">
                        <img class="img-xs rounded-circle " src="{{ asset('uploads/' . Auth::user()->image) }}"
                            alt="error">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('/lingkupbisnis')}}">
                <span class="menu-icon">
                    <i class="mdi mdi-office-building"></i>
                </span>
                <span class="menu-title">Lingkup Bisnis</span>
            </a>
        </li>
        <li class="nav-item menu-items">
