        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ route('account.store')}}" enctype="multipart/form-data" class="forms-sample">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text-white @error('name') is-invalid @enderror"
                        placeholder="Input Name" name="name" value="{{ old('name') }}" required autocomplete="name"
                        autofocus>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control text-white  @error('email') is-invalid @enderror"
                        placeholder="Input Email" name="email" value="{{ old('email') }}" required autocomplete="email">
                    @error('email')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password"
                        ...
                        placeholder="input Pssword Confirmation" name="password_confirmation" required
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-xs-12">
                        <input type="file"
                            class="form-control file-upload-info @error('profile_picture') is-invalid @enderror pb-5"
