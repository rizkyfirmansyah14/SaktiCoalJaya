    ...
    <div class="col-xl-4 col-sm-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                            <h3 class="mb-0">{{ $count_business}}</h3>
                        </div>
                    </div>
                    <div class="col-3">
                ...
                <h6 class="text-muted font-weight-normal">Lingkup Bisnis</h6>
            </div>
        </div>
    </div>
    <div class="col-xl-4 col-sm-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="text-muted font-weight-normal">Account</h6>
            </div>
        </div>
    </div>
    <div class="col-xl-4 col-sm-6 grid-margin stretch-card">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="show btn btn-outline-primary" nama="{{ $contact->name }}"
                                        email="{{ $contact->email }}" subject="{{ $contact->subject }}"
                                        message="{{ $contact->message }}">Details</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
